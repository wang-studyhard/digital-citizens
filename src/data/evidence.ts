...
export const evidenceMetrics: EvidenceMetric[] = [
  ...
  },
  {
    ...
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为6个点；不是全国年龄分布。',
  },
  {
    ...
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第9页（页脚08）：出生年代正文', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为48个点；不是全国年龄分布。',
  },
  {
    ...
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第9页（页脚08）：出生年代正文', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为201个点；不是全国年龄分布。',
  },
  {
    ...
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第9页（页脚08）：出生年代正文', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为27个点；不是全国年龄分布。',
  },
  {
