...
export const evidenceMetrics: EvidenceMetric[] = [
  {
    ...
    locator: '公开预览 p.04“研究说明”：问卷回收段', claimType: 'survey-statistic', status: 'reported',
  ...
  },
  {
    ...
    population: 'NCC 社区渠道问卷参与者', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '公开预览 p.04“研究说明”：清洗后有效问卷段', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false,
  },
  {
    ...
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '公开预览 p.04“研究说明”：样本构成段', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false,
  ...
  },
  {
    ...
    locator: '公开预览 p.04“研究说明”：结构化访谈段', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false,
  },
  {
    id: 'ncc-age-70s', value: 2.13, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第9页（页脚08）：出生年代正文', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为6个点；不是全国年龄分布。报告图旁标签与正文不一致，当前采用正文值。',
  },
  {
    id: 'ncc-age-80s', value: 17.02, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第9页（页脚08）：出生年代正文', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为48个点；不是全国年龄分布。报告图旁标签与正文不一致，当前采用正文值。',
  },
  {
    id: 'ncc-age-90s', value: 71.28, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第9页（页脚08）：出生年代正文', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为201个点；不是全国年龄分布。报告图旁标签与正文不一致，当前采用正文值。',
  },
  {
    id: 'ncc-age-00s', value: 9.57, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第9页（页脚08）：出生年代正文', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为27个点；不是全国年龄分布。报告图旁标签与正文不一致，当前采用正文值。',
  },
  {
    id: 'ncc-education-bachelor', value: 61.34, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第11页（页脚10）：学历分布图', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为173个点；不是全国学历分布。',
  },
  {
    id: 'ncc-education-master', value: 23.76, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第11页（页脚10）：学历分布图', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为67个点；不是全国学历分布。',
  },
  {
    id: 'ncc-education-doctor', value: 1.42, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第11页（页脚10）：学历分布图', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为4个点；不是全国学历分布。',
  },
  {
    id: 'ncc-education-junior', value: 13.48, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第11页（页脚10）：学历分布图', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为38个点；不是全国学历分布。',
  },
  {
    id: 'ncc-gender-male', value: 51.77, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第11页（页脚10）：性别分布图', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为146个点；不是全国性别分布。',
  },
  {
    id: 'ncc-gender-female', value: 46.10, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第11页（页脚10）：性别分布图', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为130个点；不是全国性别分布。',
  },
  {
    id: 'ncc-gender-nonbinary', value: 2.13, unit: '%',
    population: 'NCC 282名数字游民样本', geography: '中国（社区渠道）', scope: 'community-channel-sample',
    period: '2024-04—2024-05', cutoff: '调查结束：2024-05', sourceId: 1,
    locator: '原始阅读器第11页（页脚10）：性别分布图', claimType: 'survey-statistic', status: 'reported',
    canUseAsPrimary: true, canGeneralizeNationally: false, note: '按 n=282 重绘为6个点；不是全国性别分布。',
  },
  {
