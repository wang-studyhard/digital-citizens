...
export const references: Reference[] = [
  { id: 1, title: '《全景式数字游民洞察报告》（公开预览）', source: 'NCC / 第三方公开预览，2024年4—5月调查', url: 'https://www.fxbaogao.com/detail/4614525', status: 'reported', locator: '公开预览 p.04“研究说明”：问卷回收、有效样本与样本构成段；完整阅读器需登录，报告原图未纳入本仓库', note: '仅用于说明社区渠道样本的方法与边界，不承担全国规模或全国人口结论。' },
