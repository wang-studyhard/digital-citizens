...
export const references: Reference[] = [
  { id: 1, title: '《全景式数字游民洞察报告》（原始阅读器）', source: 'NCC / 发现报告阅读器，2024年4—5月调查', url: 'https://www.fxbaogao.com/detail/4614525', status: 'reported', locator: '公开预览 p.04“研究说明”；登录后原始阅读器第9页（页脚08）年龄/经历、第11页（页脚10）性别/学历；报告整页未纳入本仓库', note: '仅用于说明社区渠道样本的方法、边界与已核验画像字段，不承担全国规模或全国人口结论。' },
  ...
  { id: 7, title: '在丽水，看见诗画中国', source: '浙江在线，2025-12-04', url: 'https://zjnews.zjol.com.cn/ymkzj/202512/t20251204_31380400.shtml', status: 'reported', locator: '正文丽水数字游民社区与旅居型驿站数据段', note: '主线仅概述公开报道中的政策方向与进展，具体资格以正式政策文本为准。' },
  ...
  { id: 14, title: '浙江丽水：红绿生辉处 老区“新”意浓', source: '人民网浙江频道，2026-06-18', url: 'https://zj.people.com.cn/n2/2026/0618/c186327-41615033.html', status: 'reported', locator: '正文数字游民社区与共创项目数据段', note: '公开报道已给出 2026 年进展；页面抓取不稳定，主线保留报道状态。' },
  { id: 15, title: '2026年安吉县青年入乡发展会议暨数字游民共创计划发布会举行', source: '新华网客户端，安吉县委宣传部，2026-04-30', url: 'https://app.xinhuanet.com/news/article.html?articleId=20260430f2a4c089608644dd82108d3f970021e5', status: 'verified', locator: '正文第16—18段', note: '青年入乡与数字游民共创计划的县域公开报道，不等于数字游民人口统计。' },
  { id: 16, title: '黄山市人民政府关于黟县数字游民生态的公开信息', source: '黄山市人民政府，2025', url: 'https://www.huangshan.gov.cn/zwgk/public/6615714/11966730.html', status: 'reported', locator: '正文数字游民社区与民宿产业融合段', note: '公开政府页面已列出后续进展；主线只保留报道口径，不推导因果经济贡献。' },
]
