...
export const hotspots: GeoHotspot[] = [
  ...
  },
  {
    ...
    description: '经典数字游民聚集地，苍山洱海间的远程办公天堂',
  },
  {
    city: '丽水',
    province: '浙江',
    coordinates: [119.92, 28.47],
    description: '全国首个县级数字游民专项政策出台地',
  },
  {
    city: '黄山',
    province: '安徽',
    ...
    community: 'NCC社区',
    description: '2027目标建成8个国家级数字游民创新基地',
  },
  {
    city: '泉州',
    province: '福建',
    coordinates: [118.59, 24.91],
    description: '世界遗产城市，数字游民新兴目的地',
  },
  {
    city: '成都',
    province: '四川',
    ...
    community: '天星村',
    description: '四川首个"数字游民聚落"，2023年正式开放',
  },
  {
    city: '南京',
    province: '江苏',
    ...
    community: '莱斯社区',
    description: '八百好社 + 莱斯社区，城市型数字游民空间',
  },
  {
    city: '上海',
    province: '上海',
  ...
  },
  {
    ...
    community: 'Q Space',
    description: '700+成员入驻，累计入住人次超2.5万',
  },
  {
    city: '威海',
    province: '山东',
    coordinates: [122.12, 37.51],
    description: '山东省数字游民政策先行区',
  },
]
